...
session_start();
$id_theme = $_GET['id_intitule'];
$_SESSION['id_face'] = $id_theme;
include 'config.php';
$query="SELECT * FROM Theme WHERE id_face='$id_face'";
if($result=mysqli_query($conn,$query))
{
   while ($ligne = mysqli_fetch_assoc($result))
   {
      $titre = $ligne['intitule'];
      $categorie = $ligne['descriptif'];
      $descriptif =  $ligne['Etat'];
      ?>
